...
\chapter{Appendix C: Mood Detection Results} % Main appendix title

\label{AppendixC} % For referencing this appendix elsewhere, use \ref{AppendixA}

\lhead{Appendix C. \emph{Mood Detection Results}} % This is for the header on each page - perhaps a shortened title
