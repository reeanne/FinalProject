...
\chapter{Acknowledgements} % Main chapter title

\label{Acknowledgements} % Change X to a consecutive number; for referencing this chapter elsewhere, use \ref{ChapterX}

\lhead{Acknowledgements} % Change X to a consecutive number; this is for the header on each page - perhaps a shortened title
