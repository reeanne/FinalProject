...
\vspace{-30pt}
  \begin{center}
    \includegraphics[width=0.48\textwidth]{Figures/CollectionView}
  \end{center}
  \caption{Screenshot of the game in the song selection menu.}
\label{fig:spngselection}
\end{wrapfigure}
...
To design the song selection view, we made use of the NSCollectionView, which allows to display objects in a grid. Each view in the grid is represented by a NSCollectionViewItem object, which manages the loading of the view's content.
