...
In addition to this, we analised the accuracy of pitch prediction for each of the algorithms. 
To do so, we computed the fraction of voiced frames in reference file for which the algorithms provided a correct frequency values. As we can see in Table \ref{table:melodypitchchroma}.
...
Imagine						& 3m 12s		&	0		& 26s 422ms		\\	\hline
Johnny B. Goode		& 2m 20s		&	0		& 29s 932ms		\\ 	\hline
Like a Rolling Stone	& 1m 32s		&	1h 59m 52s 630ms		& 9s 193ms		\\ 	\hline
Respect						& 2m 35s		&	0		& 12s 597ms		\\ 	\hline
Satisfaction				& 3m 43s		& 	0		& 15s 65ms		\\	\hline
\end{tabular}
\caption{Table showing the recall and false alarm for each of the algorithms when analysing against ground truth files.}
