...
\begin{figure}
        ...
        \begin{subfigure}[b]{0.47\textwidth}
                ...
                \label{fig:synSSM}
        \end{subfigure}
          \caption{Comparison of SSM generated from unprocessed and enhanced chromas.}
...
\begin{figure}
        ...
        \begin{subfigure}[b]{0.47\textwidth}
                ...
                \label{fig:synMFCC}
        \end{subfigure}
          \caption{Comparison of SSM generated from unprocessed and enhanced MFCCs.}
...
Finally, we compute the SSM. Again, we investigated the possibility of computing it using Euclidean, Manhattan and cosine distances. The result of this process can be seen in \ref{fig:synMFCC}.
...
The N x N score matrix is approximately factorized into product of a N x k matrix W and a k x N matrix H. The jth column of W can be viewed as the vector template for the j th segment type. The j th column of H describes the intensities of the k segment types for the jth window. An example in shown in Figure 4.
