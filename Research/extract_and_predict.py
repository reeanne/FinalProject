...
min_max_file = '/Users/paulinakoch/Documents/Year 4/Project/FinalProject/Research/Mood/minMax.csv'
...
def process_track(file, intervals):
	...
	for i in range(0, len(intervals)-1):
		startdata[start] = intervals[i]
		startdata[end] = intervals[i+1]
